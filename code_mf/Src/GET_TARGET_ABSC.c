...
void GET_TARGET_ABSC()
{
    while(1)
    {
        ...
        MOTOR_11_TARGET_ABSC = MOTOR_11_TARGET_OUTPUT_SHAFT * (float)pp_2_shaft * MOTOR_11_TURN;
        MOTOR_12_TARGET_ABSC = MOTOR_12_TARGET_OUTPUT_SHAFT * (float)pp_2_shaft * MOTOR_12_TURN;
        ...
        MOTOR_21_TARGET_ABSC = MOTOR_21_TARGET_OUTPUT_SHAFT * (float)pp_2_shaft * MOTOR_21_TURN;
        MOTOR_22_TARGET_ABSC = MOTOR_22_TARGET_OUTPUT_SHAFT * (float)pp_2_shaft * MOTOR_22_TURN;
