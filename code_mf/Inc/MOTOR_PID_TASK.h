...
#define MOTOR_3508_SPEED_PID_KI 0.04f
#define MOTOR_3508_SPEED_PID_KD 0.0f
#define MOTOR_3508_SPEED_PID_OUT_MAX 16000.0f//电机输出的最大劲
#define MOTOR_3508_SPEED_PID_KI_MAX 10000.0f

#define MOTOR_3508_ANGLE_PID_KP 0.5f
