...
#define MOTOR_11_OUTPUT_SHAFT_ERROR (-0.73f *M_PI)
#define MOTOR_12_OUTPUT_SHAFT_ERROR (0.90f *M_PI)
#define MOTOR_13_OUTPUT_SHAFT_ERROR (-0.73f *M_PI)
#define MOTOR_14_OUTPUT_SHAFT_ERROR (0.90f *M_PI)
#define MOTOR_21_OUTPUT_SHAFT_ERROR (-0.73f *M_PI)
#define MOTOR_22_OUTPUT_SHAFT_ERROR (0.90f *M_PI)
#define MOTOR_23_OUTPUT_SHAFT_ERROR (-0.73f *M_PI)
#define MOTOR_24_OUTPUT_SHAFT_ERROR (0.90f *M_PI)
